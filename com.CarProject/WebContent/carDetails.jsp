...
<img style= "width:60%" src="<c:out value="${newCar.imgUrl}" />">
</div>
...
<br>
 ...
 <table class= "detail-table" style="width:60%;margin-left:auto;
   ...
   <tr class="detail-table">
    ...
    <td class="detail-table"><c:out value="${newCar.id}"/></td>
    
  </tr>
  <tr class="detail-table">
    <td class="detail-table"><h6>MAKE</h6></td>
    <td class="detail-table"><c:out value="${newCar.make}"/></td>
    
  </tr>
  <tr class="detail-table">
    <td class="detail-table"><h6>MODEL</h6></td>
    <td class="detail-table"><c:out value="${newCar.model}"/></td>
    
  </tr>
   <tr class="detail-table">
    <td class="detail-table"><h6>VEHICLE TYPE</h6></td>
    <td class="detail-table">#</td>
    
  </tr>
   <tr class="detail-table">
    <td class="detail-table"><h6>VEHICLE YEAR</h6></td>
    <td class="detail-table"><c:out value="${newCar.year}"/></td>
    
  </tr>
   <tr class="detail-table">
    <td class="detail-table"><h6>CONDITION</h6></td>
    <td class="detail-table">NEW</td>
    
  </tr>
   <tr class="detail-table">
    <td class="detail-table"><h6>PRICE</h6></td>
    <td class="detail-table"><c:out value="${newCar.price}"/></td>
    
  </tr>
   <tr class="detail-table">
    <td class="detail-table"><h6>DESCRIPTION</h6></td>
    <td class="detail-table">#</td>
